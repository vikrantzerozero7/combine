...
def generate_bilingual_html(config, layout, language, languages_dict):
    """Generate HTML/JS"""
    ...
    lang_badge = languages_dict[language]
...
# Call the function with LANGUAGES
html_content = generate_bilingual_html(PHYSICS_CONFIG, LAYOUT_CONFIG, selected_language, LANGUAGES)
...
if st.checkbox("Show Debug Info / डीबग जानकारी दिखाएं", key="phy_debug"):
    st.write(f"**Debug - selected_language = {selected_language}**")
